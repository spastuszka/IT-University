  ...
  <header class="site-header">
    <div class="container">
      <h1 class="school-logo-text float-left">
        <a href="<?php echo site_url(); ?>"><strong>IT</strong> University</a>
      </h1>
      ...
      <div class="site-header__menu group">
        ...
        <div class="site-header__util">
          ...
          <?php } else { ?>
            ...
            <a href="<?php /*echo esc_url(site_url('/wp-signup.php'));*/ echo wp_registration_url(); ?>" class="btn btn--small btn--dark-orange float-left">Sign Up</a>
          <?php } ?>
